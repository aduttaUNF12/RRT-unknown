...
resumptionPoint=start;
    ...
    for i = 1:size(obstaclesList,1)
        ...
        [newPathMatrix, solutionInfo, collisionPoint, resumptionPoint] = ...
            TangentBugWithReplanning(map, currentPathMatrix, solutionInfo, goal, EPS, numNodes, validationDist,resumptionPoint);
