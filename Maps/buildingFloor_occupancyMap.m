...
buildingFloorMap = binaryOccupancyMap(highResMap, 100); % 100 cells per unit size
save("gridmaps.mat","buildingFloorMap");
% Display the final map
figure;
show(buildingFloorMap);
hold on;
