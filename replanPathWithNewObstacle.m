function [replannedSegment, solutionInfo,si,sj,s,g,collisionDetected] = replanPathWithNewObstacle(simpleMap,originalPath,EPS,numNodes,validationDist,radius,rectCenter)
